...
(function () {
  ...
  /**
   * @param {string} path      e.g. "/employees/{id}"
  ...
  window.Api = {
    ...
    createAccount: function (employeeId, role, username, password) {
      return request("/auth/accounts", {
        method: "POST",
        body: { employee_id: employeeId, role: role, username: username, password: password }
      });
    },
    logout: function () {
